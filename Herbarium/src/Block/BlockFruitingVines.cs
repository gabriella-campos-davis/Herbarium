    ...
    public class BlockFruitingVines : HerbariumBerryBush
    {
        ...
        public override bool CanPlantStay(IBlockAccessor blockAccessor, BlockPos pos)
        {
            ...
            if ((belowBlock is BlockFruitingVines || belowBlock is BlockTreeVine) && !Attributes["isBottomBlock"].AsBool())
            {
                ...
                bool canAttach = blockAccessor.GetBlock(attachingBlockPos).CanAttachBlockAt(blockAccessor, this, attachingBlockPos, facing, null);
                bool canAttachBelow = blockAccessor.GetBlock(attachingBelowBlockPos).CanAttachBlockAt(blockAccessor, this, attachingBelowBlockPos, facing, null);
