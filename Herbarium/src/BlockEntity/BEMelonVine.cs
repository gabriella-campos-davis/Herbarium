...
namespace herbarium
{
    public class BlockEntityMelonVine : BlockEntity
    {
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            stage1VineBlock = api.World.GetBlock(new AssetLocation(melonBlockCode + "-vine-1-normal"));
            melonBlock = api.World.GetBlock(new AssetLocation(melonBlockCode + "-fruit-1"));
